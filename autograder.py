...
def run_test(test_name, module_dict, print_test_case=False, display=None):
    ...
    test_dict = test_parser.TestParser(testName + ".test").parse()
    solution_dict = test_parser.TestParser(testName + ".solution").parse()
    ...
    testCase.execute(grades, module_dict, solution_dict)
